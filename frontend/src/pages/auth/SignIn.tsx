  ...
  return <Layout> 
    <div className='flex justify-center w-full'>
      <div className='w-full max-w-md bg-white rounded-lg shadow-lg p-6'>
        <h1 className='text-3xl font-bold text-center text-gray-500 mb-5'>Welcome Back</h1>
        ...
        <Link 
        to={'/sign-up'} 
        className="text-sm font-medium text-indigo-600 hover:text-indigo-500 transition-all duration-300 pt-3"> 
